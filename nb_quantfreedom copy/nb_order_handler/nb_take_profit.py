...
def long_tp_rr(
    ...
    logger[LoggerFuncType.Debug](
        "nb_take_profit.py - nb_Long_RR - calculate_take_profit() - profit= "
    ...
    logger[LoggerFuncType.Debug](
        "nb_take_profit.py - nb_Long_RR - calculate_take_profit() - tp_price= "
    ...
    logger[LoggerFuncType.Debug]("nb_take_profit.py - nb_Long_RR - calculate_take_profit() - can_move_sl_to_be= True")
    return (
        can_move_sl_to_be,
        tp_price,
        tp_pct,
...
def long_c_tp_hit_regular(
    ...
    logger[LoggerFuncType.Debug](
        "nb_take_profit.py - long_c_tp_hit_regular() - candle_high= "
        + stringer[StringerFuncType.float_to_str](candle_high)
    )
    if tp_price < candle_high:
        logger[LoggerFuncType.Debug]("nb_take_profit.py - long_c_tp_hit_regular() - TP Hit")
        return True
    else:
        logger[LoggerFuncType.Debug]("nb_take_profit.py - long_c_tp_hit_regular() - No Tp Hit")
        return False
...
def long_c_tp_hit_provided(
    ...
    if not np.isnan(tp_price):
        logger[LoggerFuncType.Debug](
            "nb_take_profit.py - long_c_tp_hit_provided() - Tp Hit Exit Price= "
            + stringer[StringerFuncType.float_to_str](tp_price)
        )
        return True
    else:
        logger[LoggerFuncType.Debug]("nb_take_profit.py - long_c_tp_hit_provided() - No Tp Hit")
        return False
