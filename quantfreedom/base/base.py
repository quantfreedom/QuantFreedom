...
def backtest_df_only(
    ...
    Quick Summary
    -------------
        The main way to backtest your strategy. I highly highly highly suggest watching the explainer video because I would be here typing up a book explaining exactly what everything does and means. You will get a ver brief summary of each variable but the video goes into great detail.

        !!! warning
            Everything here that deals with percent needs to be 1 for 1 percent or 20 for 20% or 24.5 for 24.5% ... do not ... i repeat do not do .01 for 1%
