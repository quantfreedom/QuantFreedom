...
from quantfreedom.exchanges.apex_exchange.apex_github.helpers.util import round_size
...
print(feeRes)
crossWithdrawRes = client.cross_chain_withdraw(
    amount="1003", expirationEpochSeconds=currentTime, asset="USDC", fee=feeRes["data"]["fee"], chainId="97"
)
