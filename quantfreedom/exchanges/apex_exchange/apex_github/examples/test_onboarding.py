...
from quantfreedom.exchanges.apex_exchange.apex_github.constants import REGISTER_ENVID_MAIN
...
EXPECTED_STARK_KEY_PAIR_WITH_Y_COORDINATE_MAINNET = {
    ...
    "private_key": "0x170d807cafe3d8b5758f3f698331d292bf5aeb71f6fd282f0831dee094ee891",
}
...
class TestOnboarding:
    def test_derive_stark_key_on_mainnet_from_web3(self):
        ...
        client = HTTP(
            host=DEFAULT_HOST,
            network_id=REGISTER_ENVID_MAIN,
            web3=web3,
        )
    ...
    def test_recover_default_api_key_credentials_on_mainnet_from_web3(self):
        ...
        signer_address = web3.eth.accounts[0]
        api_key_credentials = client.onboarding.recover_default_api_key_credentials(
            signer_address,
        )
