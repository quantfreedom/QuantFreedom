...
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import (
    ONE_HOUR_IN_SECONDS,
    WITHDRAWAL_TO_ADDRESS_PREFIX,
    ORDER_SIGNATURE_EXPIRATION_BUFFER_HOURS,
)
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import WITHDRAWAL_FIELD_BIT_LENGTHS
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import WITHDRAWAL_PADDING_BITS
...
class SignableWithdrawal(Signable):
    ...
    def _calculate_hash(self):
        ...
        return get_hash(
            get_hash(self.collateral_asset_id, int(self._message.eth_address, 16)),
            packed,
        )
