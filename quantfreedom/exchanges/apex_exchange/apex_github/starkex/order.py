...
from quantfreedom.exchanges.apex_exchange.apex_github.constants import COLLATERAL_ASSET, ASSET_RESOLUTION
from quantfreedom.exchanges.apex_exchange.apex_github.constants import ORDER_SIDE_BUY
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import ONE_HOUR_IN_SECONDS
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import ORDER_FIELD_BIT_LENGTHS
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import ORDER_PADDING_BITS
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import ORDER_PREFIX
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.constants import ORDER_SIGNATURE_EXPIRATION_BUFFER_HOURS
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.helpers import nonce_from_client_id
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.helpers import to_quantums_exact
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.helpers import to_quantums_round_down
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.helpers import to_quantums_round_up
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.signable import Signable
from quantfreedom.exchanges.apex_exchange.apex_github.starkex.starkex_resources.proxy import get_hash
...
class SignableOrder(Signable):
    def __init__(
        ...
        # collateral_asset_id = int(collateral_asset_id, 16),
