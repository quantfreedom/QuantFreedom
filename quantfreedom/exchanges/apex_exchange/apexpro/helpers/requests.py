...
from quantfreedom.exchanges.apex_exchange.apexpro.errors import ApexproApiError
from quantfreedom.exchanges.apex_exchange.apexpro.helpers.request_helpers import remove_nones
...
def request(uri, method, headers=None, data_values={}):
    response = send_request(uri, method, headers, data=json.dumps(remove_nones(data_values)))
