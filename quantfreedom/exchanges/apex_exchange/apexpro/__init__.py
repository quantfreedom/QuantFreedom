...
from quantfreedom.exchanges.apex_exchange.apexpro.eth_signing import SignWithWeb3, SignOnboardingAction
from quantfreedom.exchanges.apex_exchange.apexpro.eth_signing import SignWithKey
...
from quantfreedom.exchanges.apex_exchange.apexpro.starkex.helpers import private_key_to_public_key_pair_hex
...
class HTTP:
    ...
    def __init__(
        ...
        self.logger.info(
            ...
            "from quantfreedom.exchanges.apex_exchange.apexpro import HTTP; "
        )
