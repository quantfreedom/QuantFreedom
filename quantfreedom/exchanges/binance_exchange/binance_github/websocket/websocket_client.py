...
from quantfreedom.exchanges.binance_exchange.binance_github.websocket.binance_socket_manager import BinanceSocketManager
...
class BinanceWebsocketClient:
    ...
    def list_subscribe(self, id=None):
        ...
        if not id:
            id = get_timestamp()
        self.socket_manager.send_message(json.dumps({"method": "LIST_SUBSCRIPTIONS", "id": id}))
