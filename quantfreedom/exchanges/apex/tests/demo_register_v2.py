...
nonceRes = client.generate_nonce(refresh="false", starkKey=stark_key_pair_with_y_coordinate['public_key'],ethAddress=client.default_address, chainId=NETWORKID_TEST)
