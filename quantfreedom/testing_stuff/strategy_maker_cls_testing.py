...
from quantfreedom.testing_stuff.helper_funcs_testing import (
    boradcast_to_1d_arrays_nb_testing,
)
from quantfreedom.testing_stuff.simulate_testing import _sim_6_testing
...
class StrategyMaker:
    ...
    def backtest_df_testing(
        ...
        self.strat_results_df, self.settings_results_df = backtest_df_only_testing(
    ...
    def strategy_dashboard(self, row_id):
        ...
        entries, os_broadcast_arrays = boradcast_to_1d_arrays_nb_testing(
            order_settings_arrays=order_settings_arrays,
            entries=entry_data.values,
        )

        order_records = _sim_6_testing(
