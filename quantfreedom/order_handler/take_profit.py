...
def long_tp_rr(
    ...
    logger[LoggerFuncType.Debug](
        ".take_profit.py - .Long_RR - calculate_take_profit() - profit= "
    ...
    logger[LoggerFuncType.Debug](
        ".take_profit.py - .Long_RR - calculate_take_profit() - tp_price= "
    ...
    logger[LoggerFuncType.Debug](
        ".take_profit.py - .Long_RR - calculate_take_profit() - tp_pct= "
        + stringer[StringerFuncType.float_to_str](round(tp_pct * 100, 3))
    )
    can_move_sl_to_be = True
    logger[LoggerFuncType.Debug](".take_profit.py - .Long_RR - calculate_take_profit() - can_move_sl_to_be= True")
    return (
        can_move_sl_to_be,
        tp_price,
        tp_pct,
