...
from old_quantfreedom._typing import RecordArray, Array1d, Array2d, PossibleArray
...
def all_os_as_1d_arrays_nb(
    ...
    trail_sl_when_pct_from_avg_entry_array = to_1d_array_nb(
        np.asarray(
...
def check_os_1d_arrays_nb(
    ...
    if not np.isnan(order_settings_arrays_tuple.risk_reward).any() and check_sl_for_nan:
