...
from nb_quantfreedom.nb_enums import LoggerFuncType, RejectedOrder, StringerFuncType
...
def c_too_b_s(
    ...
    if entry_size_asset < min_asset_size:
        logger[LoggerFuncType.Warning](
            "nb_increase_position.py - c_too_b_s() - entry size too small "
            + "entry_size_asset= "
        ...
        logger[LoggerFuncType.Warning](
            "nb_increase_position.py - c_too_b_s() - entry size too big"
            + "entry_size_asset= "
            + stringer[StringerFuncType.float_to_str](entry_size_asset)
            + " > max_asset_size= "
    ...
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - c_too_b_s() - Entry size is fine"
        + "entry_size_asset= "
        + stringer[StringerFuncType.float_to_str](entry_size_asset)
    )
...
def c_pl_ra_ps(
    ...
    """
    logger[LoggerFuncType.Debug]("nb_increase_position.py - c_pl_ra_ps() - Inside")
    possible_loss = round(possible_loss + account_state_equity * risk_account_pct_size, 0)
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - c_pl_ra_ps() -" + " possible_loss= " + str(int(possible_loss))
    )
    max_equity_risk = round(account_state_equity * max_equity_risk_pct)
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - c_pl_ra_ps() -" + " max_equity_risk= " + str(int(max_equity_risk))
    )
    if possible_loss > max_equity_risk:
        logger[LoggerFuncType.Warning](
            "nb_increase_position.py - c_pl_ra_ps() - Too big"
            + " possible_loss= "
    ...
    total_trades += 1
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - c_pl_ra_ps() - PL is fine"
        + " possible_loss= "
        + str(int(possible_loss))
        + " max risk= "
        + str(int(max_equity_risk))
...
def c_total_trades(
    ...
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - c_total_trades() -" + " possible_loss= " + str(int(possible_loss))
    )
    total_trades += 1
    if total_trades > max_trades:
        logger[LoggerFuncType.Warning](
            "nb_increase_position.py - c_total_trades() - Max trades reached"
            + " total trades= "
            + str(int(total_trades))
            + " max trades= "
            + str(int(max_trades))
...
def long_rpa_slbcb(
    ...
    if order_info.in_position:
        logger[LoggerFuncType.Debug]("nb_increase_position.py - long_rpa_slbcb() - We are in a position")
        ...
        logger[LoggerFuncType.Debug]("nb_increase_position.py - long_rpa_slbcb() - Not in a position")
...
def long_rpa_slbcb_p(
    ...
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_rpa_slbcb_p() - Calculating")
    ...
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - long_rpa_slbcb_p() - "
        + "entry_size_usd= "
...
def long_rpa_slbcb_np(
    ...
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_rpa_slbcb_np() - Calculating")
    possible_loss, total_trades = c_pl_ra_ps(
        logger=logger,
        possible_loss=possible_loss,
        account_state_equity=account_state_equity,
    ...
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - long_rpa_slbcb_np() - "
        + "entry_size_usd= "
        + stringer[StringerFuncType.float_to_str](entry_size_usd)
    )
...
def long_min_amount(
    ...
    """
    if order_info.in_position:
        logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount() - We are in a position")
        ...
        logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount() - Not in a position")
...
def long_min_amount_p(
    ...
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount_p() - Calculating")

    position_size_asset += min_asset_size
    entry_size_asset = min_asset_size
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - long_min_amount_p() - entry_size_asset position_size_asset{entry_size_asset, position_size_asset}"
    )

    entry_size_usd = round(min_asset_size * entry_price, 4)
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount_p() - entry_size_usd entry_size_usd}")
    ...
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount_p() - average_entry average_entry}")

    sl_pct = round((average_entry - sl_price) / average_entry, 4)
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount_p() - sl_pct={round(sl_pct*100,2))")

    position_size_usd = round(entry_size_usd + position_size_usd, 4)
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount_p() - position_size_usd position_size_usd}")
    ...
    logger[LoggerFuncType.Debug](
        "nb_increase_position.py - long_min_amount_p() - possible_loss, total_trades {possible_loss, total_trades}"
    )
...
def long_min_amount_np(
    ...
    logger[LoggerFuncType.Debug]("nb_increase_position.py - long_min_amount_np() - Calculating")
