    ...
    def __init__(
        ...
        if order_settings.long_or_short == LongOrShortType.Long:
            self.obj_stop_loss = StopLossLong(
                ...
                sl_bcb_type=order_settings.sl_bcb_type,
                sl_to_be_cb_type=order_settings.sl_to_be_cb_type,
                sl_to_be_when_pct=order_settings.sl_to_be_when_pct,
                sl_to_be_ze_type=order_settings.sl_to_be_ze_type,
                sl_type=order_settings.stop_loss_type,
                trail_sl_bcb_type=order_settings.trail_sl_bcb_type,
                trail_sl_by_pct=order_settings.trail_sl_by_pct,
                trail_sl_when_pct=order_settings.trail_sl_when_pct,
...
sl_bcb_type = {CandleBodyType._fields[order_settings.sl_bcb_type]}\n\
sl_based_on_add_pct = {round(order_settings.sl_based_on_add_pct*100,2)}\n\
sl_based_on_lookback = {order_settings.sl_based_on_lookback}\n\
sl_to_be_cb_type = {CandleBodyType._fields[order_settings.sl_to_be_cb_type]}\n\
sl_to_be_when_pct = {order_settings.sl_to_be_when_pct}\n\
sl_to_be_ze_type = {SLToBeZeroOrEntryType._fields[order_settings.sl_to_be_ze_type]}\n\
trail_sl_bcb_type = {CandleBodyType._fields[order_settings.trail_sl_bcb_type]}\n\
trail_sl_when_pct = {round(order_settings.trail_sl_when_pct*100,2)}\n\
